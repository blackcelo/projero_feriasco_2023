describe('Login', () => {
    ...
    it('Login Elegível com sucesso', () => {
        ...
        .type('elegivelstagin@yopmail.com')
        cy.get('#celular')
        .type('11992704855')
        cy.get('app-identificacao-usuario > .fc-btn')
        .click()
        cy.get('#nav-options > :nth-child(7)')
        .contains('Olá Elegível, vamos viajar? ')
...
describe('Login Elegível premiado', () => {
    ...
    it('Login Elegível premiado com sucesso', () => {
        ...
        .type('727.456.981-33')
        cy.get('#personal-email')
        .type('elegivelpremiado@yopmail.com')
        cy.get('#celular')
        .type('11992704966')
        cy.get('app-identificacao-usuario > .fc-btn')
        .click()
...
describe('Tentativa Login CPF invalido', () => {
    ...
    it('Login CPF invalido', () => {
        ...
        .contains('Informe um número de CPF válido')
        cy.get('#cpf')
        .clear('555.555.555-55')
        .type('225.715')
        cy.get('app-identificacao-usuario > .fc-btn')
        .click()
        cy.get('.error-message')
...
describe('Tentativa de Login Assinante', () => {
    ...
    it('Login Assinante', () => {
        ...
        .type('733.544.736-49')
        cy.get('#personal-email')
        .type('assinanteautstg@yopmail.com')
        cy.get('#celular')
        .type('11992704077')
        cy.get('app-identificacao-usuario > .fc-btn')
        .click()
...
describe('Login Elegível celular invalido', () => {
    ...
    it('Login elegível celular invalido', () => {
        ...
        .type('445.506.078-23')
        cy.get('#personal-email')
        .type('celularinvalido@yopmail.com')
        cy.get('#celular')
        .type('11555555555')
        cy.get('app-identificacao-usuario > .fc-btn')
        .click()
...
describe('Tentativa de Login sem preencher todos os campos', () => {
    ...
    it('Tentativa de Login sem preencher todos os campos', () => {
        ...
        .type('445.506.078-23')
        cy.get('#personal-email')
        .type('sempreencher@yopmail.com')
        cy.get('#celular')
        cy.get('app-identificacao-usuario > .fc-btn')
        cy.get('#celular')
        .type('11994073434')
        cy.get('#cpf')
        .clear('445.506.078-23')
        cy.get('app-identificacao-usuario > .fc-btn')
        cy.get('#personal-email')
        .clear('sempreencher@yopmail.com')
        cy.get('#cpf')
        .type('445.506.078-23')
        cy.get('app-identificacao-usuario > .fc-btn')
